...
jobs:
  review:
    ...
    with:
      ...
      max_cost_usd: '0.25'
      cost_rates: 'openrouter/z-ai/glm-5.1=1.40:4.40,xiaomi/mimo-v2.5-pro=0.435:0.87'
```
...
| `cost_rates` | string | `openrouter/z-ai/glm-5.1=1.40:4.40,xiaomi/mimo-v2.5-pro=0.435:0.87` | `model=input:output` USD-per-million-token overrides for models without built-in OpenRouter pricing. DeepSeek uses OpenRouter's built-in rates. |
